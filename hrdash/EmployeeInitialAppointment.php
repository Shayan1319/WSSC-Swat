                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="" placeholder="Employee Manager" class="form-control" autocomplete="off" required="">
                                      </div>
                                    </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                        <label>Joining Date</label>
                                        <input type="date" name="" placeholder="Joining Date" class="form-control" autocomplete="off" required="">
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="" placeholder="Duty Point" class="form-control" autocomplete="off" required="">
                                      </div>
                                  </div>
                              </div>
                        </div>
